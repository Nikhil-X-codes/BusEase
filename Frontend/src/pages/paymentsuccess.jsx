...
export default function PaymentSuccess() {
  ...
  const generatePDF = () => {
    ...
    const pdfContent = `
      ...
      <head>
        ...
        <style>
          ...
          .ticket-id { color: #666; margin-top: 10px; }
          .section { margin: 20px 0; }
          .section-title { font-weight: bold; color: #3B82F6; border-bottom: 1px solid #E5E7EB; padding-bottom: 5px; margin-bottom: 15px; }
          ...
          .total { background: #3B82F6; color: white; padding: 15px; border-radius: 8px; text-align: center; font-size: 18px; font-weight: bold; }
        ...
        <div class="section">
          ...
          <div class="info-grid">
            ...
            <div class="info-item">
              ...
              <div class="info-value">${bookingData.from} (${bookingData.departureTime})</div>
            </div>
            <div class="info-item">
              <div class="info-label">To</div>
              <div class="info-value">${bookingData.to} (${bookingData.arrivalTime})</div>
            </div>
          </div>
        </div>
    ...
    // Create and download the PDF content as HTML file (in a real app, you'd use a PDF library)
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-green-900/85 via-blue-800/75 to-green-800/85 backdrop-blur-sm" />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 pb-8">
        ...
        <div className="text-center mb-8">
          <div className={`inline-flex items-center justify-center w-32 h-32 rounded-full bg-green-500/20 border-4 border-green-400 transition-all duration-1000 ${showSuccess ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}`}>
            <CheckCircle className="w-16 h-16 text-green-400" />
          </div>
          <h2 className="text-4xl font-bold text-white mt-6 mb-2">Payment Successful!</h2>
          <p className="text-white/80 text-lg">Your bus ticket has been confirmed</p>
        </div>

        {/* Booking Summary */}
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 shadow-2xl mb-8">
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold text-white mb-2">Booking Confirmation</h3>
            <div className="bg-green-500/20 text-green-100 px-4 py-2 rounded-full inline-block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white/10 p-6 rounded-xl">
              ...
              <div className="space-y-3 text-white/80">
                ...
                <div className="flex justify-between">
                  <span>From</span>
                  <span className="text-white font-medium">{bookingData.from} ({bookingData.departureTime})</span>
                </div>
                <div className="flex justify-between">
                  <span>To</span>
                  <span className="text-white font-medium">{bookingData.to} ({bookingData.arrivalTime})</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={generatePDF}
              className="flex items-center justify-center space-x-2 bg-gradient-to-r from-green-500 to-blue-500 text-white py-3 px-6 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
            >
